...
public class varDef extends Operation{
    ...
    /**
     * @param expression the operation of the expression name in variable definition
     */
    ...
    public void execute(Instrument instrument) {
        ...
        if (this.type==Typ.INT) {
            ...
            setHashMap.getVariableMap().put(this.get_VarName(), new Variable<>(this.expression.getint_value()));
            ...
            setHashMap.getVariableMap().put(this.get_VarName(), new Variable<>(this.expression.getbool_value()));
